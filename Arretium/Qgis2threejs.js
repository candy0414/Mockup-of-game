...
(function () {
  ...
  app.init = function (container) {
    ...
    // app.scene.labelRootElement = document.getElementById("label");
    // app.scene.labelRootElement2 = document.getElementById("label2");

    // app.scene.labelRootElement.style.display = (app.labelVisible) ? "block" : "none";
    // app.scene.labelRootElement2.style.display = (app.labelVisible) ? "block" : "none";
  ...
  app.buildNorthArrow = function (container, rotation) {
    ...
    var geometry = new THREE.PlaneGeometry( 20, 20, 20, 25,25 );
  ...
  app.setLabelVisible = function (visible) {
    ...
    // app.scene.labelRootElement2.style.display = (visible) ? "block" : "none";
    ...
    if (jsonObject.data !== undefined) {
      ...
      if (this.properties.label !== undefined) {
        ...
        if (this.labelParentElement === undefined) {
          ...
          // scene.labelRootElement2.appendChild(this.labelParentElement);
